...
def run_full_scale_verification():
    ...
    with open(result_path, "w", encoding='utf-8') as f:
        ...
        f.write("=========================================\n")
        f.write(f"Date: January 14, 2026 (Post-Critique Revision)\n")
        f.write("\n")
        f.write("CRITIQUE FIXES APPLIED:\n")
        f.write("-----------------------\n")
        f.write("1. Strong Coupling Bound: beta <= 0.40 (extended via Dobrushin)\n")
        f.write("   - Classic Cluster Expansion valid for beta <= 0.016\n")
        f.write("   - Finite Size Criterion extends certificate to beta <= 0.40\n")
